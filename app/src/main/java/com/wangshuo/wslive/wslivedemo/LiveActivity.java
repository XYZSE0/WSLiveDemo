...
public class LiveActivity extends AppCompatActivity {
    ...
    public void initLiveConfig() {
        ...
        files.add(new GPUImageCompatibleFilter(new GPUImageBeautyFilter()));    //滤镜
        files.add(new WatermarkFilter(BitmapFactory.decodeResource(getResources(),R.mipmap.live),new Rect(100,100,200,200)));   //水印
